...
*
* \funcusage
*  \snippet P0_0_SUT.c usage_P0_0_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet P0_0_SUT.c usage_P0_0_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet P0_0_SUT.c usage_P0_0_Read  
*******************************************************************************/
...
* preferred P0_0_Read() API because the 
* P0_0_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet P0_0_SUT.c usage_P0_0_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: P0_0_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use P0_0_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - P0_0_0_INTR       (First pin in the list)
    *  - P0_0_1_INTR       (Second pin in the list)
    *  - ...
    *  - P0_0_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet P0_0_SUT.c usage_P0_0_SetInterruptMode
    *******************************************************************************/
    void P0_0_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & P0_0_0_INTR) != 0u) 
		{ 
			 P0_0_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet P0_0_SUT.c usage_P0_0_ClearInterrupt
    *******************************************************************************/
