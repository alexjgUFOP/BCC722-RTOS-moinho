...
#ifdef ProbeUART_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG
    #define ProbeUART_CONTROL_REG_REMOVED            (0u)
#else
    #define ProbeUART_CONTROL_REG_REMOVED            (1u)
#endif /* End ProbeUART_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG */
...
typedef struct _ProbeUART_backupStruct
{
    uint8 enableState;
...
/* Status Register definitions */
#if( (ProbeUART_TX_ENABLED) || (ProbeUART_HD_ENABLED) )
    #if(ProbeUART_TX_INTERRUPT_ENABLED)
        #define ProbeUART_TX_VECT_NUM                ProbeUART_TXInternalInterrupt__INTC_NUMBER
        #define ProbeUART_TX_PRIOR_NUM               ProbeUART_TXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* ProbeUART_TX_INTERRUPT_ENABLED */
    #if(ProbeUART_TX_ENABLED) 
    ...
    #define ProbeUART_TX_STS_COMPLETE                (0x01u << ProbeUART_TX_STS_COMPLETE_SHIFT)
    #define ProbeUART_TX_STS_FIFO_EMPTY              (0x01u << ProbeUART_TX_STS_FIFO_EMPTY_SHIFT)
    #define ProbeUART_TX_STS_FIFO_FULL               (0x01u << ProbeUART_TX_STS_FIFO_FULL_SHIFT)
    #define ProbeUART_TX_STS_FIFO_NOT_FULL           (0x01u << ProbeUART_TX_STS_FIFO_NOT_FULL_SHIFT)
#endif /* End (ProbeUART_TX_ENABLED) || (ProbeUART_HD_ENABLED)*/

#if( (ProbeUART_RX_ENABLED) || (ProbeUART_HD_ENABLED) )
    #if(ProbeUART_RX_INTERRUPT_ENABLED)
        #define ProbeUART_RX_VECT_NUM                ProbeUART_RXInternalInterrupt__INTC_NUMBER
        #define ProbeUART_RX_PRIOR_NUM               ProbeUART_RXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* ProbeUART_RX_INTERRUPT_ENABLED */
    ...
    #define ProbeUART_RX_STS_MRKSPC                  (0x01u << ProbeUART_RX_STS_MRKSPC_SHIFT)
    #define ProbeUART_RX_STS_BREAK                   (0x01u << ProbeUART_RX_STS_BREAK_SHIFT)
    #define ProbeUART_RX_STS_PAR_ERROR               (0x01u << ProbeUART_RX_STS_PAR_ERROR_SHIFT)
    #define ProbeUART_RX_STS_STOP_ERROR              (0x01u << ProbeUART_RX_STS_STOP_ERROR_SHIFT)
    #define ProbeUART_RX_STS_OVERRUN                 (0x01u << ProbeUART_RX_STS_OVERRUN_SHIFT)
    #define ProbeUART_RX_STS_FIFO_NOTEMPTY           (0x01u << ProbeUART_RX_STS_FIFO_NOTEMPTY_SHIFT)
    #define ProbeUART_RX_STS_ADDR_MATCH              (0x01u << ProbeUART_RX_STS_ADDR_MATCH_SHIFT)
    #define ProbeUART_RX_STS_SOFT_BUFF_OVER          (0x01u << ProbeUART_RX_STS_SOFT_BUFF_OVER_SHIFT)
...
#define ProbeUART_CTRL_HD_SEND                       (0x01u << ProbeUART_CTRL_HD_SEND_SHIFT)
#define ProbeUART_CTRL_HD_SEND_BREAK                 (0x01u << ProbeUART_CTRL_HD_SEND_BREAK_SHIFT)
#define ProbeUART_CTRL_MARK                          (0x01u << ProbeUART_CTRL_MARK_SHIFT)
#define ProbeUART_CTRL_PARITY_TYPE_MASK              (0x03u << ProbeUART_CTRL_PARITY_TYPE0_SHIFT)
#define ProbeUART_CTRL_RXADDR_MODE_MASK              (0x07u << ProbeUART_CTRL_RXADDR_MODE0_SHIFT)
...
#define ProbeUART_BIT_CENTER                         (ProbeUART_OVER_SAMPLE_COUNT - 1u)
...
#define ProbeUART_TXBITCTR_BREAKBITS   (ProbeUART_BREAK_BITS_TX * ProbeUART_OVER_SAMPLE_COUNT - 1u)
    ...
    #define ProbeUART_HD_RXBITCTR_INIT   ((ProbeUART_BREAK_BITS_RX + \
    ProbeUART_NUMBER_OF_START_BIT) * ProbeUART_OVER_SAMPLE_COUNT - 1u + \
    (ProbeUART_OVER_SAMPLE_COUNT / 2u) + (ProbeUART_USE23POLLING * 2u) - 1u)
    ...
    #define ProbeUART_HD_RXBITCTR_INIT   (7u * ProbeUART_OVER_SAMPLE_COUNT - 1u  +  \
       (ProbeUART_OVER_SAMPLE_COUNT / 2u) + (ProbeUART_USE23POLLING * 2u) - 1u)
...
#define ProbeUART_INIT_TX_INTERRUPTS_MASK \
                                          (1 << ProbeUART_TX_STS_COMPLETE_SHIFT) \
...
***************************************/
    ...
    #define ProbeUART_CONTROL_REG \
                            (* (reg8 *) ProbeUART_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG )
