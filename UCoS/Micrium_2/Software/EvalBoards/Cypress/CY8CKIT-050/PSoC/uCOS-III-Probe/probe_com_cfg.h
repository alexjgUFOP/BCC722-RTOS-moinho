...
#define  PROBE_COM_CFG_SERIAL_EN                   DEF_DISABLED /* Configure Serial Communication availability.         */
...
#define  PROBE_RS232_CFG_TASK_PRIO                         4    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_SERIAL_CFG_TASK_PRIO                       13    /*  Configure parse task priority   (see Note #2a).     */
#define  PROBE_SERIAL_CFG_TASK_STK_SIZE                  256    /*  Configure parse task stack size (see Note #2b).     */
...
#define  PROBE_TCPIP_CFG_TASK_PRIO                        14    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                          15    /*  (c) Set task priority.                              */
