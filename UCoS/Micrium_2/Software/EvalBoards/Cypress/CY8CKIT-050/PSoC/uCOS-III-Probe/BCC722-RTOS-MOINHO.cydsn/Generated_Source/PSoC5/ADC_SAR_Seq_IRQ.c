...
void ADC_SAR_Seq_IRQ_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ADC_SAR_Seq_IRQ__INTC_NUMBER] = address;
}
...
cyisraddress ADC_SAR_Seq_IRQ_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ADC_SAR_Seq_IRQ__INTC_NUMBER];
}
...
{
    *ADC_SAR_Seq_IRQ_INTC_PRIOR = priority << 5;
}
...
uint8 ADC_SAR_Seq_IRQ_GetPriority(void)
{
    ...
    priority = *ADC_SAR_Seq_IRQ_INTC_PRIOR >> 5;
