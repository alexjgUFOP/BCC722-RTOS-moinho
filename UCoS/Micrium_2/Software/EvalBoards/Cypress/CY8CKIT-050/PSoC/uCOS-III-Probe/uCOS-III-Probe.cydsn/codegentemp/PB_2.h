...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the PB_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(PB_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in PB_2_SetInterruptMode() function.
     *  @{
     */
        #define PB_2_INTR_NONE      (uint16)(0x0000u)
        #define PB_2_INTR_RISING    (uint16)(0x0001u)
        #define PB_2_INTR_FALLING   (uint16)(0x0002u)
        #define PB_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define PB_2_INTR_MASK      (0x01u) 
#endif /* (PB_2__INTSTAT) */
...
/* SIO registers */
#if defined(PB_2__SIO_CFG)
    #define PB_2_SIO_HYST_EN        (* (reg8 *) PB_2__SIO_HYST_EN)
    #define PB_2_SIO_REG_HIFREQ     (* (reg8 *) PB_2__SIO_REG_HIFREQ)
    #define PB_2_SIO_CFG            (* (reg8 *) PB_2__SIO_CFG)
    #define PB_2_SIO_DIFF           (* (reg8 *) PB_2__SIO_DIFF)
#endif /* (PB_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define PB_2_0_INTTYPE_REG 		(* (reg8 *) PB_2__0__INTTYPE)
#endif /* (PB_2__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_PB_2_H */
