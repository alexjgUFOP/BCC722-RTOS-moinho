...
#if !defined(ProbeUART_RxISR__REMOVED) /* Check for removal by optimization */
...
void ProbeUART_RxISR_Start(void)
{
    ...
    /* Set the priority. */
    ProbeUART_RxISR_SetPriority((uint8)ProbeUART_RxISR_INTC_PRIOR_NUMBER);
...
{
    #ifdef ProbeUART_RxISR_INTERRUPT_INTERRUPT_CALLBACK
        ProbeUART_RxISR_Interrupt_InterruptCallback();
    #endif /* ProbeUART_RxISR_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*   before the component has been started use ProbeUART_RxISR_StartEx instead.
* 
*   When defining ISR functions, the CY_ISR and CY_ISR_PROTO macros should be 
*   used to provide consistent definition across compilers:
*
...
void ProbeUART_RxISR_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ProbeUART_RxISR__INTC_NUMBER] = address;
}
...
cyisraddress ProbeUART_RxISR_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ProbeUART_RxISR__INTC_NUMBER];
}
...
*
*   Note calling ProbeUART_RxISR_Start or ProbeUART_RxISR_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ProbeUART_RxISR_Start or ProbeUART_RxISR_StartEx has been called. 
...
uint8 ProbeUART_RxISR_GetState(void)
{
    ...
    return ((*ProbeUART_RxISR_INTC_SET_EN & (uint32)ProbeUART_RxISR__INTC_MASK) != 0u) ? 1u:0u;
}
