...
{
    uint8 staticBits = (InputPin_DR & (uint8)(~InputPin_MASK));
    InputPin_DR = staticBits | ((uint8)(value << InputPin_SHIFT) & InputPin_MASK);
}
...
{
	CyPins_SetPinDriveMode(InputPin_0, mode);
}
...
{
    return (InputPin_PS & InputPin_MASK) >> InputPin_SHIFT;
}
...
{
    return (InputPin_DR & InputPin_MASK) >> InputPin_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & InputPin_0_INTR) != 0u) 
		{ 
			 InputPin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (InputPin_INTSTAT & InputPin_MASK) >> InputPin_SHIFT;
    }
