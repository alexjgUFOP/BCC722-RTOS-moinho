// ======================================================================
// ADC_SAR_Seq_Example01.v generated from TopDesign.cysch
// 10/20/2022 at 08:44
...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=11368422, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=6, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONFIG_TITLE=SAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR_Seq_SAR, )
module ADC_SAR_v3_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("7f6c32a1-2aa4-4a19-b580-d82eb5b76fe2/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1999998, Adjust=0, ClockSource=1, InputRange=1, NumChannels=4, Reference=1, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=6, SampleRate=111111, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONFIG_TITLE=ADC_SAR_Seq, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq, CY_INSTANCE_SHORT_NAME=ADC_SAR_Seq, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR_Seq, )
module ADC_SAR_SEQ_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("7f6c32a1-2aa4-4a19-b580-d82eb5b76fe2/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=50, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=800, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_4, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_4, CY_INSTANCE_SHORT_NAME=VDAC8_4, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_4, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=37, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=592, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_3, CY_INSTANCE_SHORT_NAME=VDAC8_3, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_3, )
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bcab7091-6110-4737-93e2-16de5ba44894/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__vdac_pin_4_net;
	wire [0:0] tmpFB_0__vdac_pin_4_net;
	wire [0:0] tmpIO_0__vdac_pin_4_net;
	wire [0:0] tmpINTERRUPT_0__vdac_pin_4_net;
	electrical [0:0] tmpSIOVREF__vdac_pin_4_net;

	cy_psoc3_pins_v1_10
		#(.id("9517f49b-3b95-446f-944a-046e71ac0611"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		vdac_pin_4
		 (.oe(tmpOE__vdac_pin_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vdac_pin_4_net[0:0]}),
		  .analog({Net_2492}),
		  .io({tmpIO_0__vdac_pin_4_net[0:0]}),
		  .siovref(tmpSIOVREF__vdac_pin_4_net),
		  .interrupt({tmpINTERRUPT_0__vdac_pin_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vdac_pin_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__vdac_pin_3_net;
	wire [0:0] tmpFB_0__vdac_pin_3_net;
	wire [0:0] tmpIO_0__vdac_pin_3_net;
	wire [0:0] tmpINTERRUPT_0__vdac_pin_3_net;
	electrical [0:0] tmpSIOVREF__vdac_pin_3_net;

	cy_psoc3_pins_v1_10
		#(.id("0e9be6e8-8de3-42cd-8821-d076639d9b77"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vdac_pin_3
		 (.oe(tmpOE__vdac_pin_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vdac_pin_3_net[0:0]}),
		  .analog({Net_2493}),
		  .io({tmpIO_0__vdac_pin_3_net[0:0]}),
		  .siovref(tmpSIOVREF__vdac_pin_3_net),
		  .interrupt({tmpINTERRUPT_0__vdac_pin_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vdac_pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__vdac_pin_2_net;
	wire [0:0] tmpFB_0__vdac_pin_2_net;
	wire [0:0] tmpIO_0__vdac_pin_2_net;
	wire [0:0] tmpINTERRUPT_0__vdac_pin_2_net;
	electrical [0:0] tmpSIOVREF__vdac_pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d9295ac8-8543-450c-a91e-4039988867f8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vdac_pin_2
		 (.oe(tmpOE__vdac_pin_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vdac_pin_2_net[0:0]}),
		  .analog({Net_2494}),
		  .io({tmpIO_0__vdac_pin_2_net[0:0]}),
		  .siovref(tmpSIOVREF__vdac_pin_2_net),
		  .interrupt({tmpINTERRUPT_0__vdac_pin_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vdac_pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__vdac_pin_1_net;
	wire [0:0] tmpFB_0__vdac_pin_1_net;
	wire [0:0] tmpIO_0__vdac_pin_1_net;
	wire [0:0] tmpINTERRUPT_0__vdac_pin_1_net;
	electrical [0:0] tmpSIOVREF__vdac_pin_1_net;

	cy_psoc3_pins_v1_10
		#(.id("fad24f43-79d1-44b6-a38d-c910bfb573a4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vdac_pin_1
		 (.oe(tmpOE__vdac_pin_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vdac_pin_1_net[0:0]}),
		  .analog({Net_2495}),
		  .io({tmpIO_0__vdac_pin_1_net[0:0]}),
		  .siovref(tmpSIOVREF__vdac_pin_1_net),
		  .interrupt({tmpINTERRUPT_0__vdac_pin_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vdac_pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_2 VDAC8_4 (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_2492));
    defparam VDAC8_4.Data_Source = 0;
    defparam VDAC8_4.Initial_Value = 50;
    defparam VDAC8_4.Strobe_Mode = 0;

    VDAC8_v1_90_3 VDAC8_3 (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_2493));
    defparam VDAC8_3.Data_Source = 0;
    defparam VDAC8_3.Initial_Value = 37;
    ...
    defparam VDAC8_1.Initial_Value = 12;
    defparam VDAC8_1.Strobe_Mode = 0;

    VDAC8_v1_90_6 VDAC8_2 (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_2494));
    defparam VDAC8_2.Data_Source = 0;
    defparam VDAC8_2.Initial_Value = 25;
	...
	cy_psoc3_pins_v1_10
		#(.id("21ebb129-2c8d-4b57-9189-136c6e4b6f5f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("33302a65-ecea-4a16-8bd2-0b7c36128308"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d908f9fa-94e4-4f15-a943-347d9a379d11"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("573a49c7-934d-47cb-84be-fe461dbf85cc"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("909090909.090909"),
		  .is_direct(0),
		  .is_digital(1))
		Clock
		 (.clock_out(Net_2392));
