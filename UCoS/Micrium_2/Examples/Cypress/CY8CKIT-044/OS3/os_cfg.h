...
#define OS_CFG_STK_SIZE_MIN             32u                /* Minimum allowable task stack size                                     */


                                                           /* --------------------------- EVENT FLAGS ----------------------------- */
#define OS_CFG_FLAG_EN                  DEF_DISABLED        /* Enable (DEF_ENABLED) code generation for EVENT FLAGS                  */
...
#define OS_CFG_FLAG_PEND_ABORT_EN       DEF_DISABLED       /*     Include (DEF_ENABLED) code for OSFlagPendAbort()                  */
                                                           ...
                                                           /* ------------------------ MEMORY MANAGEMENT -------------------------  */
#define OS_CFG_MEM_EN                   DEF_DISABLED        /* Enable (DEF_ENABLED) code generation for the MEMORY MANAGER           */


                                                           /* ------------------- MUTUAL EXCLUSION SEMAPHORES --------------------  */
#define OS_CFG_MUTEX_EN                 DEF_DISABLED        /* Enable (DEF_ENABLED) code generation for MUTEX                        */
...
#define     OS_CFG_TICK_WHEEL_SIZE     16u         // checar: eduardo 
#define    OS_CFG_TMR_WHEEL_SIZE        16u    // checar: eduardo 
