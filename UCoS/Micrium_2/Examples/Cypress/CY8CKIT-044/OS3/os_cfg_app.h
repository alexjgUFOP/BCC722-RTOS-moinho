...
#define  OS_CFG_MSG_POOL_SIZE                         4u       /* Maximum number of messages                           */
...
#define  OS_CFG_STAT_TASK_STK_SIZE                   64u       /* Stack size (number of CPU_STK elements)              */


                                                                /* ---------------------- TICKS ----------------------- */
#define  OS_CFG_TICK_RATE_HZ                        1000u       /* Tick rate in Hertz (10 to 1000 Hz)                   */
#define  OS_CFG_TICK_TASK_PRIO                        10u       /* Priority                                             */
#define  OS_CFG_TICK_TASK_STK_SIZE                   64u       /* Stack size (number of CPU_STK elements)              */
